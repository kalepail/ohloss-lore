...
Now the three clans band together once more, each earning faction points through various competitions. Alone, none are powerful enough to challenge Empress Zebulita. But together, they might amass enough power to break her rule. Yet even in alliance, ambition remains: when the throne is finally empty, only one faction will claim the right to replace Zebulita. Or will they learn from their mistakes and leave the throne empty?`
  ...
  villain: {
    title: 'Vexmor the Undying',
    subtitle: 'Lord of the Obsidian Throne',
    sections: [
      {
        heading: 'The Man He Was',
        content: `Before he became a monster, Vexmor was perhaps the most gifted mage ever born. Child prodigy, master of seven schools of magic by age twenty, youngest-ever member of the Arcanum Council—his achievements seemed limitless.

But Vexmor had a secret terror: he was afraid of death. Not the pain of dying, but the void that came after. The idea of simply ceasing to exist haunted his dreams and drove his every action.`
      },
      {
        heading: 'The Pact',
        content: `In the forbidden archives beneath the Arcanum Tower, Vexmor found texts that spoke of the Endless Void—not as death, but as a form of existence. The Void, the texts claimed, was infinite and eternal. Those who joined with it would never end.

What the texts did not say was that the Void was hungry. It sought to consume all of creation, returning everything to the primordial darkness. And it needed a champion in the world of light.

When Vexmor opened the Void Gate, he expected to gain immortality. Instead, the Void consumed everything that made him human and replaced it with endless hunger. He got his wish—he would never die. But the man named Vexmor had already ceased to exist.`
      },
      {
        heading: 'The Undying Lord',
        content: `What remains is something that wears Vexmor's face but serves only the Void's purpose: the extinction of all light, all life, all existence. The Shadow Dominion is simply a tool toward this end.

Yet fragments of the original Vexmor occasionally surface—a hesitation, a moment of what might be regret, a flash of the brilliant scholar he once was. Some believe these fragments might be the key to defeating him. Others say they are merely tricks of a master manipulator.

One thing is certain: Vexmor cannot be killed by conventional means. The Void sustains him, and only by somehow severing his connection to it can he truly be stopped.`
      }
    ]
  }
};
